    ...
    <>
      ...
      >
        ...
        <p className="text-lg text-gray-400 font-extralight text-center mb-8 max-w-xl">
          Enter a stock ticker to get a forecast powered by machine learning and
        ...
        <div className="max-w-5xl mx-auto space-y-10 font-light">
          <div>
            ...
            <p className="text-lg font-extralight text-gray-400 leading-relaxed">
              ...
              AI-driven platform designed to help users anticipate short-term
              market behavior using
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Provide data-backed insights to empower smarter trading
                decisions — even for non-experts.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
          ...
          <div className="mt-12">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Below is a real-time snapshot of trending stocks we&apos;re
              tracking:
            </p>
            <TopStocks />
          </div>
