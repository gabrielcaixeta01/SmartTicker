...
export default async function ResultPage({ params }: Props) {
    ...
    return (
      <main className="w-full max-w-3xl mx-auto px-4 py-20 text-center text-red-400">
        <h2 className="text-2xl font-light mb-4">
          Erro ao buscar dados para &quot;{ticker}&quot;
        </h2>
  ...
  if (!data) {
    return (
      <main className="w-full max-w-3xl mx-auto px-4 py-20 text-center text-gray-300 animate-pulse">
        <h2 className="text-2xl font-light mb-4">Carregando resultado...</h2>
      </main>
    );
  }
